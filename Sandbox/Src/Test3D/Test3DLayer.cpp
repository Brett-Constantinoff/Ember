...
void Test3DLayer::onAttach(Ember::Core::Window* win)
{
    ...
    Ember::Renderer::Material quadMat{ {0.25f, 0.25f, 0.25f}, {0.25f, 0.25f, 0.25f}, {0.1f, 0.1f, 0.1f}, 5.0f, SHADER_PATH "directionalLighting.hlsl", true };
    ...
    m_scene.addDirLight(new Ember::Scene::DirectionalLight{ {-0.2f, -1.0f, -0.5f}, {1.0f, 1.0f, 1.0f}, {0.2f, 0.2f, 0.2f}, {1.0f, 1.0f, 1.0f} });
