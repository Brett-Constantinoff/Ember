...
void Test3DLayer::onAttach(Ember::Core::Window* win)
{
    ...
    Ember::Renderer::Transformation cubeTransform0{ {10.0f, 0.0f, 10.0f}, {1.0f, 1.0f, 1.0f}, glm::mat4(1.0f) };
    ...
    Ember::Renderer::Transformation cubeTransform2{ {-10.0f, 0.0f, -10.0f}, {1.0f, 1.0f, 1.0f}, glm::mat4(1.0f) };
    ...
    m_scene.addDirLight(new Ember::Scene::DirectionalLight{ {-2.0f, 20.0f, -2.0f}, {1.0f, 1.0f, 1.0f}, {0.2f, 0.2f, 0.2f}, {1.0f, 1.0f, 1.0f} });
